      ...
      <div className='properties'>
        {selectedShape ? (
          <>
            ...
            <div className='key'>
              Stroke <input className='value' name='stroke' type='color' value={selectedShape.stroke} onChange={updateAttr} />
            </div>

            <div className='key'>
              Fill <input className='value' name='fill' type='color' value={selectedShape.fill} onChange={updateAttr} />
            </div>
          </>
        ) : (
