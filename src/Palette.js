...
export function Palette() {
  return (
    <aside className='palette'>
      <h2>Object</h2>
      <div className='shape rectangle' data-shape={SHAPE_TYPES.RECT} draggable onDragStart={handleDragStart} />
      <div className='shape circle' data-shape={SHAPE_TYPES.CIRCLE} draggable onDragStart={handleDragStart} />
    </aside>
  );
}
